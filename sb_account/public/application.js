...
*/
}, "spine/lib/relation": function(exports, require, module) {// Generated by CoffeeScript 1.6.3
(function() {
...
*/
}, "spine/lib/ajax": function(exports, require, module) {// Generated by CoffeeScript 1.6.3
(function() {
...
*/
}, "controllers/circles": function(exports, require, module) {(function() {
  var Circle, Circles, Friends, I, Key, Spine, User,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Circles = (function(_super) {
    ...
    Circles.prototype.tag = 'li';

    function Circles(circle) {
      this.circle = circle;
      this.deroule = __bind(this.deroule, this);
      Circles.__super__.constructor.apply(this, arguments);
      console.log("render ");
      console.log(this.circle.name);
      this.render();
    }

    Circles.prototype.render = function() {
      return this.html(require('views/circle')({
        name: this.circle.name
      }));
    };

    Circles.prototype.elements = {
      '.more': 'more'
    };

    Circles.prototype.events = {
      'click p': 'deroule'
    };

    Circles.prototype.deroule = function() {
      var id, item, present, _i, _j, _len, _len1, _ref, _ref1, _ref2, _results;
      if (Friends.selected) {
        present = false;
        _ref = User.find(User.selected_id).items;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          item = _ref[_i];
        ...
        if (!present) {
          Key.create({
            ...
            user_id: I.id,
            dest_id: User.selected_id
          });
        }
      }
      if ((_ref1 = Circles.selected) != null) {
        _ref1.render();
      }
      Circles.selected = this;
      this.more.html('');
      _ref2 = Circle.find(this.circle.id).items;
      _results = [];
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        id = _ref2[_j];
        _results.push(this.more.append('<li>' + User.find(id).pseudo + '</li>'));
      }
      return _results;
    };
...
}, "controllers/friends": function(exports, require, module) {(function() {
  var Friends, Spine, User,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Friends = (function(_super) {
    ...
    Friends.prototype.render = function() {
      return this.html(require('views/friend')(this.user));
    };
    ...
    Friends.prototype.deroule = function() {
      if (Friends.selected != null) {
        Friends.selected.$('p').css('color', '');
      }
      Friends.selected = this;
      User.selected_id = this.user.id;
      return this.$('p').css('color', 'red');
    };
  ...
  var Circle, Circles, Friends, I, Key, Main, Spine, User,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Main = (function(_super) {
    ...
    function Main() {
      var circle, data, key, user, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
        _this = this;
      Main.__super__.constructor.apply(this, arguments);
      Circle.bind('reset', function() {
        return Circle.each(function(circle) {
          return circle.view.el.html('');
        });
      });
      Circle.bind('create', function(circle) {
        circle.view = new Circles(circle.toJSON());
        return _this.circles.append(circle.view.el);
      });
      Key.bind('create', function(key) {
        return User.each(function(user) {
          var circle;
          if (key.user_id === I.id && key.dest_id === user.id) {
            if (key.circle_id) {
              circle = Circle.find(key.circle_id);
              return circle.items.push(key.dest_id);
            } else {
              return _this.friends.append((new Friends(user.toJSON())).el);
            }
          }
        });
      });
      User.bind('create', function(user) {
        return Key.each(function(key) {
          var circle;
          if (key.user_id === I.id && key.dest_id === user.id) {
            if (key.circle_id) {
              circle = Circle.find(key.circle_id);
    ...
    Main.prototype.add_circle = function() {
      return Circle.create({
        name: prompt("circle name")
      });
    };

    Main.prototype.add_friend = function() {};
...
}, "data/test": function(exports, require, module) {(function() {
  module.exports = {
    pseudo: "max",
    pubkey: "lmazlmzd",
    circles: [
    ...
    keys: [
      {
        ...
        user_id: 12,
        dest_id: 1,
        data: "dsfsdfKdlfmssfdfsdsdf,lsmqs"
      }, {
        user_id: 9,
        dest_id: 1,
        data: "dsfsdfdlmf,k,vdklvd,dlv,sdKdlfmssfdfsdsdf,lsmqs"
      }
    ],
    users: [
      {
...
sjcl.ecc.ecdsa.publicKey.prototype={verify:function(a,b,c){sjcl.bitArray.bitLength(a)>this.l&&(a=sjcl.bitArray.clamp(a,this.l));var d=sjcl.bitArray,e=this.i.r,f=this.l,g=sjcl.bn.fromBits(d.bitSlice(b,0,f)),d=sjcl.bn.fromBits(d.bitSlice(b,f,2*f)),h=c?d:d.inverseMod(e),f=sjcl.bn.fromBits(a).mul(h).mod(e),h=g.mul(h).mod(e),f=this.i.G.mult2(f,h,this.F).x;if(g.equals(0)||d.equals(0)||g.greaterEquals(e)||d.greaterEquals(e)||!f.equals(g)){if(c===u)return this.verify(a,b,A);t(new sjcl.exception.corrupt("signature didn't check out"))}return A}};
}, "models/circle": function(exports, require, module) {(function() {
  var Circle, Key, Spine, User,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Circle = (function(_super) {
    ...
    Circle.configure('Circle', 'data', 'id', 'name', 'members');
    ...
    Circle.prototype.insert = function(user_id) {
      var user, value;
    ...
    Circle.prototype.value = function() {
      if (this.value == null) {
        this.value = S.bare(this.data, I.mainkey);
      }
      return this.value;
    };
...
}, "models/i": function(exports, require, module) {(function() {
  var Circle, I, Key, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  I = (function(_super) {
    ...
    I.hasMany('keys', 'models/key');

    I.hasMany('friends', 'models/key');

    I.hasMany('circles', 'models/circle');

    function I() {
      this.id = 1;
    }

    I.prototype.haveFriend = function() {
      return this.trigger('friend', user);
    };
...
}, "models/key": function(exports, require, module) {(function() {
  var Key, S, Spine, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Key = (function(_super) {
    ...
    Key.configure('Key', 'id', 'data', 'value', 'circle_id', 'user_id', 'dest_id');

    Key.prototype.creator = function() {
      return User.find(this.user_id);
    };

    Key.prototype.bare = function() {
      return this.value = S.bare(this.data, this.creator().pubkey);
    };
  ...
  User = (function(_super) {
    ...
    User.configure('User', 'id', 'pseudo', 'pubkey');
...
}, "views/circle": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
...
module.exports = content;}, "views/friend": function(exports, require, module) {(function() {


}).call(this);
}, "views/friend": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.pseudo));
...
module.exports = content;}, "views/list": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
module.exports = content;}, "views/me": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
module.exports = content;}, "views/sample": function(exports, require, module) {var content = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      var circle, user, _i, _j, _len, _len1, _ref, _ref1;
    
      __out.push('<ul>\n  <li>Me</li>\n');
    
      _ref = this.data.circles;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        circle = _ref[_i];
        __out.push('\n  <li>\n    ');
        __out.push(__sanitize(circle.name));
        __out.push('\n  </li>\n');
      }
    
      __out.push('\n');
    
      _ref1 = this.data.users;
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        user = _ref1[_j];
        __out.push('\n  <li>');
        __out.push(__sanitize(user.pseudo));
        __out.push('</li>\n');
      }
