...
}, "spine/index": function(exports, require, module) {module.exports = require('./lib/spine');}, "spine/lib/spine": function(exports, require, module) {// Generated by CoffeeScript 1.6.2
(function() {
...
*/
}, "spine/lib/local": function(exports, require, module) {// Generated by CoffeeScript 1.6.2
(function() {
  var Spine;
...
*/
}, "spine/lib/ajax": function(exports, require, module) {// Generated by CoffeeScript 1.6.2
(function() {
...
*/
}, "spine/lib/route": function(exports, require, module) {// Generated by CoffeeScript 1.6.2
(function() {
...
*/
}, "spine/lib/manager": function(exports, require, module) {// Generated by CoffeeScript 1.6.2
(function() {
  var $, Spine,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
*/
  ...
  Main = (function(_super) {
    ...
    Main.prototype.reset_input = function(e) {
      return $(e.target).removeClass("invalid");
    };

    Main.prototype.check_pseudo = function() {
      var _this = this;
      if (!/^[a-z0-9_\-]{2,}$/i.test(this.pseudo.val())) {
        return this.invalid(this.pseudo);
      } else if (this.last_pseudo !== this.pseudo.val()) {
        this.last_pseudo = this.pseudo.val();
        return User.exist(this.pseudo.val(), function(ok) {
          _this.last_pseudo = _this.pseudo.val();
          _this.last_pseudo_ok = ok;
          if (!ok) {
            return _this.invalid(_this.pseudo);
          }
        });
      } else if (!this.last_pseudo_ok) {
        return this.invalid(this.pseudo);
      }
    };

    Main.prototype.check_email = function() {
      if (!/^[0-9a-z._-]+@[0-9a-z.-]+\.[a-z]{2,6}$/i.test(this.email.val())) {
        return this.invalid(this.email);
      }
    };

    Main.prototype.check_password = function() {
      var pw;
      pw = this.password.val();
      if (!(/[0-9]+/.test(pw) && /[a-z]+/.test(pw) && /[A-Z]+/.test(pw) && pw.length >= 8)) {
        return this.invalid(this.password);
      }
    };

    Main.prototype.check_confirm = function() {
      if (this.password.val() !== this.confirm.val()) {
        return this.invalid(this.confirm);
      }
    };

    Main.prototype.invalid = function(input) {
      return input.addClass('invalid');
    };

    Main.prototype.signup = function(e) {
      var user;
      e.preventDefault();
      User.bind('ajaxSuccess', function() {
        return alert('saved');
      });
      User.bind('ajaxError', function(model, xhr) {
        return alert('error: ' + xhr.responseText);
      });
      user = User.fromForm(this.form);
      user.birth();
      return user.save();
    };
...
}, "lib/S": function(exports, require, module) {(function() {
  var S, sjcl;
  ...
  S = {
    ...
    hide: function(key, data) {
      ...
      return sjcl.bitArray.concat(iv, S.encrypt(key, data, iv));
    },
    ...
    hide_text: function(key, text) {
      return S.hide(key, sjcl.codec.utf8String.toBits(text));
    },
    ...
    bare_seckey: function(key, data) {
      return sjcl.bn.fromBits(S.bare(key, date));
    },
    ec_create: function() {
      var pubkey, seckey;
    ...
    ec_shared: function(seckey, pubkey) {
      var point;
...
}, "lib/entropy": function(exports, require, module) {(function() {
  var Entropy, entropy;
...
}, "lib/hash_file": function(exports, require, module) {(function() {
  var hash_file;
...
}, "lib/sjcl": function(exports, require, module) {"use strict";function t(a){throw a;}var u=void 0,A=!0,F=!1;var sjcl={cipher:{},hash:{},keyexchange:{},mode:{},misc:{},codec:{},exception:{corrupt:function(a){this.toString=function(){return"CORRUPT: "+this.message};this.message=a},invalid:function(a){this.toString=function(){return"INVALID: "+this.message};this.message=a},bug:function(a){this.toString=function(){return"BUG: "+this.message};this.message=a},notReady:function(a){this.toString=function(){return"NOT READY: "+this.message};this.message=a}}};
"undefined"!=typeof module&&module.exports&&(module.exports=sjcl);
sjcl.cipher.aes=function(a){this.q[0][0][0]||this.v();var b,c,d,e,f=this.q[0][4],g=this.q[1];b=a.length;var h=1;4!==b&&(6!==b&&8!==b)&&t(new sjcl.exception.invalid("invalid aes key size"));this.c=[d=a.slice(0),e=[]];for(a=b;a<4*b+28;a++){c=d[a-1];if(0===a%b||8===b&&4===a%b)c=f[c>>>24]<<24^f[c>>16&255]<<16^f[c>>8&255]<<8^f[c&255],0===a%b&&(c=c<<8^c>>>24^h<<24,h=h<<1^283*(h>>7));d[a]=d[a-b]^c}for(b=0;a;b++,a--)c=d[b&3?a:a-4],e[b]=4>=a||4>b?c:g[0][f[c>>>24]]^g[1][f[c>>16&255]]^g[2][f[c>>8&255]]^g[3][f[c&
255]]};
sjcl.cipher.aes.prototype={encrypt:function(a){return X(this,a,0)},decrypt:function(a){return X(this,a,1)},q:[[[],[],[],[],[]],[[],[],[],[],[]]],v:function(){var a=this.q[0],b=this.q[1],c=a[4],d=b[4],e,f,g,h=[],l=[],k,n,m,p;for(e=0;0x100>e;e++)l[(h[e]=e<<1^283*(e>>7))^e]=e;for(f=g=0;!c[f];f^=k||1,g=l[g]||1){m=g^g<<1^g<<2^g<<3^g<<4;m=m>>8^m&255^99;c[f]=m;d[m]=f;n=h[e=h[k=h[f]]];p=0x1010101*n^0x10001*e^0x101*k^0x1010100*f;n=0x101*h[m]^0x1010100*m;for(e=0;4>e;e++)a[e][f]=n=n<<24^n>>>8,b[e][m]=p=p<<24^p>>>8}for(e=
0;5>e;e++)a[e]=a[e].slice(0),b[e]=b[e].slice(0)}};
function X(a,b,c){4!==b.length&&t(new sjcl.exception.invalid("invalid aes block size"));var d=a.c[c],e=b[0]^d[0],f=b[c?3:1]^d[1],g=b[2]^d[2];b=b[c?1:3]^d[3];var h,l,k,n=d.length/4-2,m,p=4,r=[0,0,0,0];h=a.q[c];a=h[0];var q=h[1],C=h[2],E=h[3],D=h[4];for(m=0;m<n;m++)h=a[e>>>24]^q[f>>16&255]^C[g>>8&255]^E[b&255]^d[p],l=a[f>>>24]^q[g>>16&255]^C[b>>8&255]^E[e&255]^d[p+1],k=a[g>>>24]^q[b>>16&255]^C[e>>8&255]^E[f&255]^d[p+2],b=a[b>>>24]^q[e>>16&255]^C[f>>8&255]^E[g&255]^d[p+3],p+=4,e=h,f=l,g=k;for(m=0;4>
m;m++)r[c?3&-m:m]=D[e>>>24]<<24^D[f>>16&255]<<16^D[g>>8&255]<<8^D[b&255]^d[p++],h=e,e=f,f=g,g=b,b=h;return r}
...
sjcl.codec.base64={u:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",fromBits:function(a,b,c){var d="",e=0,f=sjcl.codec.base64.u,g=0,h=sjcl.bitArray.bitLength(a);c&&(f=f.substr(0,62)+"-_");for(c=0;6*d.length<h;)d+=f.charAt((g^a[c]>>>e)>>>26),6>e?(g=a[c]<<6-e,e+=26,c++):(g<<=6,e-=6);for(;d.length&3&&!b;)d+="=";return d},toBits:function(a,b){a=a.replace(/\s|=/g,"");var c=[],d,e=0,f=sjcl.codec.base64.u,g=0,h;b&&(f=f.substr(0,62)+"-_");for(d=0;d<a.length;d++)h=f.indexOf(a.charAt(d)),
0>h&&t(new sjcl.exception.invalid("this isn't base64!")),26<e?(e-=26,c.push(g^h>>>e),g=h<<32-e):(e+=6,g^=h<<32-e);e&56&&c.push(sjcl.bitArray.partial(e&56,g,1));return c}};sjcl.codec.base64url={fromBits:function(a){return sjcl.codec.base64.fromBits(a,1,1)},toBits:function(a){return sjcl.codec.base64.toBits(a,1)}};
sjcl.codec.sb64={u:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.,",fromBits:function(a,b,c){b="";var d=0,e=sjcl.codec.sb64.u,f=0,g=sjcl.bitArray.bitLength(a);c&&(e=e.substr(0,62)+"-_");for(c=0;6*b.length<g;)b+=e.charAt((f^a[c]>>>d)>>>26),6>d?(f=a[c]<<6-d,d+=26,c++):(f<<=6,d-=6);return b},toBits:function(a,b){a=a.replace(/\s|=/g,"");var c=[],d,e=0,f=sjcl.codec.sb64.u,g=0,h;b&&(f=f.substr(0,62)+"-_");for(d=0;d<a.length;d++)h=f.indexOf(a.charAt(d)),0>h&&t(new sjcl.exception.invalid("this isn't sb64!")),
26<e?(e-=26,c.push(g^h>>>e),g=h<<32-e):(e+=6,g^=h<<32-e);e&56&&c.push(sjcl.bitArray.partial(e&56,g,1));return c}};sjcl.codec.bytes={fromBits:function(a){var b=[],c=sjcl.bitArray.bitLength(a),d,e;for(d=0;d<c/8;d++)0===(d&3)&&(e=a[d/4]),b.push(e>>>24),e<<=8;return b},toBits:function(a){var b=[],c,d=0;for(c=0;c<a.length;c++)d=d<<8|a[c],3===(c&3)&&(b.push(d),d=0);c&3&&b.push(sjcl.bitArray.partial(8*(c&3),d));return b}};
sjcl.hash.sha256=function(a){this.c[0]||this.v();a?(this.g=a.g.slice(0),this.e=a.e.slice(0),this.d=a.d):this.reset()};sjcl.hash.sha256.hash=function(a){return(new sjcl.hash.sha256).update(a).finalize()};
sjcl.hash.sha256.prototype={blockSize:512,reset:function(){this.g=this.n.slice(0);this.e=[];this.d=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.e=sjcl.bitArray.concat(this.e,a);b=this.d;a=this.d=b+sjcl.bitArray.bitLength(a);for(b=512+b&-512;b<=a;b+=512)this.t(c.splice(0,16));return this},finalize:function(){var a,b=this.e,c=this.g,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);b.push(Math.floor(this.d/
4294967296));for(b.push(this.d|0);b.length;)this.t(b.splice(0,16));this.reset();return c},n:[],c:[],v:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}var b=0,c=2,d;a:for(;64>b;c++){for(d=2;d*d<=c;d++)if(0===c%d)continue a;8>b&&(this.n[b]=a(Math.pow(c,0.5)));this.c[b]=a(Math.pow(c,1/3));b++}},t:function(a){var b,c,d=a.slice(0),e=this.g,f=this.c,g=e[0],h=e[1],l=e[2],k=e[3],n=e[4],m=e[5],p=e[6],r=e[7];for(a=0;64>a;a++)16>a?b=d[a]:(b=d[a+1&15],c=d[a+14&15],b=d[a&15]=(b>>>7^b>>>18^b>>>3^
b<<25^b<<14)+(c>>>17^c>>>19^c>>>10^c<<15^c<<13)+d[a&15]+d[a+9&15]|0),b=b+r+(n>>>6^n>>>11^n>>>25^n<<26^n<<21^n<<7)+(p^n&(m^p))+f[a],r=p,p=m,m=n,n=k+b|0,k=l,l=h,h=g,g=b+(h&l^k&(h^l))+(h>>>2^h>>>13^h>>>22^h<<30^h<<19^h<<10)|0;e[0]=e[0]+g|0;e[1]=e[1]+h|0;e[2]=e[2]+l|0;e[3]=e[3]+k|0;e[4]=e[4]+n|0;e[5]=e[5]+m|0;e[6]=e[6]+p|0;e[7]=e[7]+r|0}};sjcl.hash.sha512=function(a){this.c[0]||this.v();a?(this.g=a.g.slice(0),this.e=a.e.slice(0),this.d=a.d):this.reset()};sjcl.hash.sha512.hash=function(a){return(new sjcl.hash.sha512).update(a).finalize()};
sjcl.hash.sha512.prototype={blockSize:1024,reset:function(){this.g=this.n.slice(0);this.e=[];this.d=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.e=sjcl.bitArray.concat(this.e,a);b=this.d;a=this.d=b+sjcl.bitArray.bitLength(a);for(b=1024+b&-1024;b<=a;b+=1024)this.t(c.splice(0,32));return this},finalize:function(){var a,b=this.e,c=this.g,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+4;a&31;a++)b.push(0);b.push(0);b.push(0);
b.push(Math.floor(this.d/0x100000000));for(b.push(this.d|0);b.length;)this.t(b.splice(0,32));this.reset();return c},n:[],fa:[12372232,13281083,9762859,1914609,15106769,4090911,4308331,8266105],c:[],ga:[2666018,15689165,5061423,9034684,4764984,380953,1658779,7176472,197186,7368638,14987916,16757986,8096111,1480369,13046325,6891156,15813330,5187043,9229749,11312229,2818677,10937475,4324308,1135541,6741931,11809296,16458047,15666916,11046850,698149,229999,945776,13774844,2541862,12856045,9810911,11494366,
7844520,15576806,8533307,15795044,4337665,16291729,5553712,15684120,6662416,7413802,12308920,13816008,4303699,9366425,10176680,13195875,4295371,6546291,11712675,15708924,1519456,15772530,6568428,6495784,8568297,13007125,7492395,2515356,12632583,14740254,7262584,1535930,13146278,16321966,1853211,294276,13051027,13221564,1051980,4080310,6651434,14088940,4675607],v:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}function b(a){return 0x10000000000*(a-Math.floor(a))&255}var c=0,d=2,e;a:for(;80>
c;d++){for(e=2;e*e<=d;e++)if(0===d%e)continue a;8>c&&(this.n[2*c]=a(Math.pow(d,0.5)),this.n[2*c+1]=b(Math.pow(d,0.5))<<24|this.fa[c]);this.c[2*c]=a(Math.pow(d,1/3));this.c[2*c+1]=b(Math.pow(d,1/3))<<24|this.ga[c];c++}},t:function(a){var b,c,d=a.slice(0),e=this.g,f=this.c,g=e[0],h=e[1],l=e[2],k=e[3],n=e[4],m=e[5],p=e[6],r=e[7],q=e[8],C=e[9],E=e[10],D=e[11],Z=e[12],P=e[13],$=e[14],Q=e[15],x=g,v=h,I=l,G=k,J=n,H=m,T=p,K=r,y=q,w=C,R=E,L=D,S=Z,M=P,U=$,N=Q;for(a=0;80>a;a++){if(16>a)b=d[2*a],c=d[2*a+1];else{c=
d[2*(a-15)];var s=d[2*(a-15)+1];b=(s<<31|c>>>1)^(s<<24|c>>>8)^c>>>7;var z=(c<<31|s>>>1)^(c<<24|s>>>8)^(c<<25|s>>>7);c=d[2*(a-2)];var B=d[2*(a-2)+1],s=(B<<13|c>>>19)^(c<<3|B>>>29)^c>>>6,B=(c<<13|B>>>19)^(B<<3|c>>>29)^(c<<26|B>>>6),V=d[2*(a-7)],W=d[2*(a-16)],O=d[2*(a-16)+1];c=z+d[2*(a-7)+1];b=b+V+(c>>>0<z>>>0?1:0);c+=B;b+=s+(c>>>0<B>>>0?1:0);c+=O;b+=W+(c>>>0<O>>>0?1:0)}d[2*a]=b|=0;d[2*a+1]=c|=0;var V=y&R^~y&S,aa=w&L^~w&M,B=x&I^x&J^I&J,fa=v&G^v&H^G&H,W=(v<<4|x>>>28)^(x<<30|v>>>2)^(x<<25|v>>>7),O=(x<<
4|v>>>28)^(v<<30|x>>>2)^(v<<25|x>>>7),ga=f[2*a],ba=f[2*a+1],s=N+((y<<18|w>>>14)^(y<<14|w>>>18)^(w<<23|y>>>9)),z=U+((w<<18|y>>>14)^(w<<14|y>>>18)^(y<<23|w>>>9))+(s>>>0<N>>>0?1:0),s=s+aa,z=z+(V+(s>>>0<aa>>>0?1:0)),s=s+ba,z=z+(ga+(s>>>0<ba>>>0?1:0)),s=s+c,z=z+(b+(s>>>0<c>>>0?1:0));c=O+fa;b=W+B+(c>>>0<O>>>0?1:0);U=S;N=M;S=R;M=L;R=y;L=w;w=K+s|0;y=T+z+(w>>>0<K>>>0?1:0)|0;T=J;K=H;J=I;H=G;I=x;G=v;v=s+c|0;x=z+b+(v>>>0<s>>>0?1:0)|0}h=e[1]=h+v|0;e[0]=g+x+(h>>>0<v>>>0?1:0)|0;k=e[3]=k+G|0;e[2]=l+I+(k>>>0<G>>>
0?1:0)|0;m=e[5]=m+H|0;e[4]=n+J+(m>>>0<H>>>0?1:0)|0;r=e[7]=r+K|0;e[6]=p+T+(r>>>0<K>>>0?1:0)|0;C=e[9]=C+w|0;e[8]=q+y+(C>>>0<w>>>0?1:0)|0;D=e[11]=D+L|0;e[10]=E+R+(D>>>0<L>>>0?1:0)|0;P=e[13]=P+M|0;e[12]=Z+S+(P>>>0<M>>>0?1:0)|0;Q=e[15]=Q+N|0;e[14]=$+U+(Q>>>0<N>>>0?1:0)|0}};
sjcl.mode.ocb2={name:"ocb2",encrypt:function(a,b,c,d,e,f){128!==sjcl.bitArray.bitLength(c)&&t(new sjcl.exception.invalid("ocb iv must be 128 bits"));var g,h=sjcl.mode.ocb2.Q,l=sjcl.bitArray,k=l.I,n=[0,0,0,0];c=h(a.encrypt(c));var m,p=[];d=d||[];e=e||64;for(g=0;g+4<b.length;g+=4)m=b.slice(g,g+4),n=k(n,m),p=p.concat(k(c,a.encrypt(k(c,m)))),c=h(c);m=b.slice(g);b=l.bitLength(m);g=a.encrypt(k(c,[0,0,0,b]));m=l.clamp(k(m.concat([0,0,0]),g),b);n=k(n,k(m.concat([0,0,0]),g));n=a.encrypt(k(n,k(c,h(c))));d.length&&
(n=k(n,f?d:sjcl.mode.ocb2.pmac(a,d)));return p.concat(l.concat(m,l.clamp(n,e)))},decrypt:function(a,b,c,d,e,f){128!==sjcl.bitArray.bitLength(c)&&t(new sjcl.exception.invalid("ocb iv must be 128 bits"));e=e||64;var g=sjcl.mode.ocb2.Q,h=sjcl.bitArray,l=h.I,k=[0,0,0,0],n=g(a.encrypt(c)),m,p,r=sjcl.bitArray.bitLength(b)-e,q=[];d=d||[];for(c=0;c+4<r/32;c+=4)m=l(n,a.decrypt(l(n,b.slice(c,c+4)))),k=l(k,m),q=q.concat(m),n=g(n);p=r-32*c;m=a.encrypt(l(n,[0,0,0,p]));m=l(m,h.clamp(b.slice(c),p).concat([0,0,0]));
k=l(k,m);k=a.encrypt(l(k,l(n,g(n))));d.length&&(k=l(k,f?d:sjcl.mode.ocb2.pmac(a,d)));h.equal(h.clamp(k,e),h.bitSlice(b,r))||t(new sjcl.exception.corrupt("ocb: tag doesn't match"));return q.concat(h.clamp(m,p))},pmac:function(a,b){var c,d=sjcl.mode.ocb2.Q,e=sjcl.bitArray,f=e.I,g=[0,0,0,0],h=a.encrypt([0,0,0,0]),h=f(h,d(d(h)));for(c=0;c+4<b.length;c+=4)h=d(h),g=f(g,a.encrypt(f(h,b.slice(c,c+4))));c=b.slice(c);128>e.bitLength(c)&&(h=f(h,d(h)),c=e.concat(c,[-2147483648,0,0,0]));g=f(g,c);return a.encrypt(f(d(f(h,
d(h))),g))},Q:function(a){return[a[0]<<1^a[1]>>>31,a[1]<<1^a[2]>>>31,a[2]<<1^a[3]>>>31,a[3]<<1^135*(a[0]>>>31)]}};
sjcl.mode.gcm={name:"gcm",encrypt:function(a,b,c,d,e){var f=b.slice(0);b=sjcl.bitArray;d=d||[];a=sjcl.mode.gcm.T(A,a,f,d,c,e||128);return b.concat(a.data,a.tag)},decrypt:function(a,b,c,d,e){var f=b.slice(0),g=sjcl.bitArray,h=g.bitLength(f);e=e||128;d=d||[];e<=h?(b=g.bitSlice(f,h-e),f=g.bitSlice(f,0,h-e)):(b=f,f=[]);a=sjcl.mode.gcm.T(F,a,f,d,c,e);g.equal(a.tag,b)||t(new sjcl.exception.corrupt("gcm: tag doesn't match"));return a.data},ea:function(a,b){var c,d,e,f,g,h=sjcl.bitArray.I;e=[0,0,0,0];f=b.slice(0);
for(c=0;128>c;c++){(d=0!==(a[Math.floor(c/32)]&1<<31-c%32))&&(e=h(e,f));g=0!==(f[3]&1);for(d=3;0<d;d--)f[d]=f[d]>>>1|(f[d-1]&1)<<31;f[0]>>>=1;g&&(f[0]^=-0x1f000000)}return e},m:function(a,b,c){var d,e=c.length;b=b.slice(0);for(d=0;d<e;d+=4)b[0]^=0xffffffff&c[d],b[1]^=0xffffffff&c[d+1],b[2]^=0xffffffff&c[d+2],b[3]^=0xffffffff&c[d+3],b=sjcl.mode.gcm.ea(b,a);return b},T:function(a,b,c,d,e,f){var g,h,l,k,n,m,p,r,q=sjcl.bitArray;m=c.length;p=q.bitLength(c);r=q.bitLength(d);h=q.bitLength(e);g=b.encrypt([0,
0,0,0]);96===h?(e=e.slice(0),e=q.concat(e,[1])):(e=sjcl.mode.gcm.m(g,[0,0,0,0],e),e=sjcl.mode.gcm.m(g,e,[0,0,Math.floor(h/0x100000000),h&0xffffffff]));h=sjcl.mode.gcm.m(g,[0,0,0,0],d);n=e.slice(0);d=h.slice(0);a||(d=sjcl.mode.gcm.m(g,h,c));for(k=0;k<m;k+=4)n[3]++,l=b.encrypt(n),c[k]^=l[0],c[k+1]^=l[1],c[k+2]^=l[2],c[k+3]^=l[3];c=q.clamp(c,p);a&&(d=sjcl.mode.gcm.m(g,h,c));a=[Math.floor(r/0x100000000),r&0xffffffff,Math.floor(p/0x100000000),p&0xffffffff];d=sjcl.mode.gcm.m(g,d,a);l=b.encrypt(e);d[0]^=l[0];
d[1]^=l[1];d[2]^=l[2];d[3]^=l[3];return{tag:q.bitSlice(d,0,f),data:c}}};sjcl.misc.hmac=function(a,b){this.V=b=b||sjcl.hash.sha256;var c=[[],[]],d,e=b.prototype.blockSize/32;this.w=[new b,new b];a.length>e&&(a=b.hash(a));for(d=0;d<e;d++)c[0][d]=a[d]^909522486,c[1][d]=a[d]^1549556828;this.w[0].update(c[0]);this.w[1].update(c[1])};sjcl.misc.hmac.prototype.encrypt=sjcl.misc.hmac.prototype.mac=function(a){a=(new this.V(this.w[0])).update(a).finalize();return(new this.V(this.w[1])).update(a).finalize()};
sjcl.misc.pbkdf2=function(a,b,c,d,e){c=c||1E3;(0>d||0>c)&&t(sjcl.exception.invalid("invalid params to pbkdf2"));"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));e=e||sjcl.misc.hmac;a=new e(a);var f,g,h,l,k=[],n=sjcl.bitArray;for(l=1;32*k.length<(d||1);l++){e=f=a.encrypt(n.concat(b,[l]));for(g=1;g<c;g++){f=a.encrypt(f);for(h=0;h<f.length;h++)e[h]^=f[h]}k=k.concat(e)}d&&(k=n.clamp(k,d));return k};
sjcl.prng=function(a){this.h=[new sjcl.hash.sha256];this.o=[0];this.P=0;this.H={};this.O=0;this.S={};this.X=this.j=this.p=this.da=0;this.c=[0,0,0,0,0,0,0,0];this.k=[0,0,0,0];this.M=u;this.N=a;this.A=F;this.L={progress:{},seeded:{}};this.s=this.ca=0;this.J=1;this.K=2;this.aa=0x10000;this.R=[0,48,64,96,128,192,0x100,384,512,768,1024];this.ba=3E4;this.$=80};
sjcl.prng.prototype={randomWords:function(a,b){var c=[],d;d=this.isReady(b);var e;d===this.s&&t(new sjcl.exception.notReady("generator isn't seeded"));if(d&this.K){d=!(d&this.J);e=[];var f=0,g;this.X=e[0]=(new Date).valueOf()+this.ba;for(g=0;16>g;g++)e.push(0x100000000*Math.random()|0);for(g=0;g<this.h.length&&!(e=e.concat(this.h[g].finalize()),f+=this.o[g],this.o[g]=0,!d&&this.P&1<<g);g++);this.P>=1<<this.h.length&&(this.h.push(new sjcl.hash.sha256),this.o.push(0));this.j-=f;f>this.p&&(this.p=f);
this.P++;this.c=sjcl.hash.sha256.hash(this.c.concat(e));this.M=new sjcl.cipher.aes(this.c);for(d=0;4>d&&!(this.k[d]=this.k[d]+1|0,this.k[d]);d++);}for(d=0;d<a;d+=4)0===(d+1)%this.aa&&ca(this),e=Y(this),c.push(e[0],e[1],e[2],e[3]);ca(this);return c.slice(0,a)},setDefaultParanoia:function(a){this.N=a},addEntropy:function(a,b,c){c=c||"user";var d,e,f=(new Date).valueOf(),g=this.H[c],h=this.isReady(),l=0;d=this.S[c];d===u&&(d=this.S[c]=this.da++);g===u&&(g=this.H[c]=0);this.H[c]=(this.H[c]+1)%this.h.length;
switch(typeof a){case "number":b===u&&(b=1);this.h[g].update([d,this.O++,1,b,f,1,a|0]);break;case "object":c=Object.prototype.toString.call(a);if("[object Uint32Array]"===c){e=[];for(c=0;c<a.length;c++)e.push(a[c]);a=e}else{"[object Array]"!==c&&(l=1);for(c=0;c<a.length&&!l;c++)"number"!=typeof a[c]&&(l=1)}if(!l){if(b===u)for(c=b=0;c<a.length;c++)for(e=a[c];0<e;)b++,e>>>=1;this.h[g].update([d,this.O++,2,b,f,a.length].concat(a))}break;case "string":b===u&&(b=a.length);this.h[g].update([d,this.O++,
3,b,f,a.length]);this.h[g].update(a);break;default:l=1}l&&t(new sjcl.exception.bug("random: addEntropy only supports number, array of numbers or string"));this.o[g]+=b;this.j+=b;h===this.s&&(this.isReady()!==this.s&&da("seeded",Math.max(this.p,this.j)),da("progress",this.getProgress()))},isReady:function(a){a=this.R[a!==u?a:this.N];return this.p&&this.p>=a?this.o[0]>this.$&&(new Date).valueOf()>this.X?this.K|this.J:this.J:this.j>=a?this.K|this.s:this.s},getProgress:function(a){a=this.R[a?a:this.N];
return this.p>=a?1:this.j>a?1:this.j/a},startCollectors:function(){this.A||(window.addEventListener?(window.addEventListener("load",this.C,F),window.addEventListener("mousemove",this.D,F)):document.attachEvent?(document.attachEvent("onload",this.C),document.attachEvent("onmousemove",this.D)):t(new sjcl.exception.bug("can't attach event")),this.A=A)},stopCollectors:function(){this.A&&(window.removeEventListener?(window.removeEventListener("load",this.C,F),window.removeEventListener("mousemove",this.D,
F)):window.detachEvent&&(window.detachEvent("onload",this.C),window.detachEvent("onmousemove",this.D)),this.A=F)},addEventListener:function(a,b){this.L[a][this.ca++]=b},removeEventListener:function(a,b){var c,d,e=this.L[a],f=[];for(d in e)e.hasOwnProperty(d)&&e[d]===b&&f.push(d);for(c=0;c<f.length;c++)d=f[c],delete e[d]},D:function(a){sjcl.random.addEntropy([a.x||a.clientX||a.offsetX||0,a.y||a.clientY||a.offsetY||0],2,"mouse")},C:function(){sjcl.random.addEntropy((new Date).valueOf(),2,"loadtime")}};
function da(a,b){var c,d=sjcl.random.L[a],e=[];for(c in d)d.hasOwnProperty(c)&&e.push(d[c]);for(c=0;c<e.length;c++)e[c](b)}function ca(a){a.c=Y(a).concat(Y(a));a.M=new sjcl.cipher.aes(a.c)}function Y(a){for(var b=0;4>b&&!(a.k[b]=a.k[b]+1|0,a.k[b]);b++);return a.M.encrypt(a.k)}sjcl.random=new sjcl.prng(6);try{var ea=new Uint32Array(32);crypto.getRandomValues(ea);sjcl.random.addEntropy(ea,1024,"crypto['getRandomValues']")}catch(ha){}sjcl.bn=function(a){this.initWith(a)};
...
c.subM(a).normalize();return c.trim()},inverseMod:function(a){var b=new sjcl.bn(1),c=new sjcl.bn(0),d=new sjcl.bn(this),e=new sjcl.bn(a),f,g=1;a.limbs[0]&1||t(new sjcl.exception.invalid("inverseMod: p must be odd"));do{d.limbs[0]&1&&(d.greaterEquals(e)||(f=d,d=e,e=f,f=b,b=c,c=f),d.subM(e),d.normalize(),b.greaterEquals(c)||b.addM(a),b.subM(c));d.halveM();b.limbs[0]&1&&b.addM(a);b.normalize();b.halveM();for(f=g=0;f<d.limbs.length;f++)g|=d.limbs[f]}while(g);e.equals(1)||t(new sjcl.exception.invalid("inverseMod: p and x must be relatively prime"));
return c},add:function(a){return this.copy().addM(a)},sub:function(a){return this.copy().subM(a)},mul:function(a){"number"===typeof a&&(a=new this.f(a));var b,c=this.limbs,d=a.limbs,e=c.length,f=d.length,g=new this.f,h=g.limbs,l,k=this.maxMul;for(b=0;b<this.limbs.length+a.limbs.length+1;b++)h[b]=0;for(b=0;b<e;b++){l=c[b];for(a=0;a<f;a++)h[b+a]+=l*d[a];--k||(k=this.maxMul,g.cnormalize())}return g.cnormalize().reduce()},square:function(){return this.mul(this)},power:function(a){"number"===typeof a?
...
sjcl.bn.random=function(a,b){"object"!==typeof a&&(a=new sjcl.bn(a));for(var c,d,e=a.limbs.length,f=a.limbs[e-1]+1,g=new sjcl.bn;;){do c=sjcl.random.randomWords(e,b),0>c[e-1]&&(c[e-1]+=0x100000000);while(Math.floor(c[e-1]/f)===Math.floor(0x100000000/f));c[e-1]%=f;for(d=0;d<e-1;d++)c[d]&=a.radixMask;g.limbs=c;if(!g.greaterEquals(a))return g}};sjcl.ecc={};sjcl.ecc.point=function(a,b,c){b===u?this.isIdentity=A:(this.x=b,this.y=c,this.isIdentity=F);this.curve=a};
sjcl.ecc.point.prototype={toJac:function(){return new sjcl.ecc.pointJac(this.curve,this.x,this.y,new this.curve.field(1))},mult:function(a){return this.toJac().mult(a,this).toAffine()},mult2:function(a,b,c){return this.toJac().mult2(a,this,b,c).toAffine()},multiples:function(){var a,b,c;if(this.W===u){c=this.toJac().doubl();a=this.W=[new sjcl.ecc.point(this.curve),this,c.toAffine()];for(b=3;16>b;b++)c=c.add(this),a.push(c.toAffine())}return this.W},isValid:function(){return this.y.square().equals(this.curve.b.add(this.x.mul(this.curve.a.add(this.x.square()))))},
toBits:function(){return sjcl.bitArray.concat(this.x.toBits(),this.y.toBits())}};sjcl.ecc.pointJac=function(a,b,c,d){b===u?this.isIdentity=A:(this.x=b,this.y=c,this.z=d,this.isIdentity=F);this.curve=a};
sjcl.ecc.pointJac.prototype={add:function(a){var b,c,d,e;this.curve!==a.curve&&t("sjcl['ecc']['add'](): Points must be on the same curve to add them!");if(this.isIdentity)return a.toJac();if(a.isIdentity)return this;b=this.z.square();c=a.x.mul(b).subM(this.x);if(c.equals(0))return this.y.equals(a.y.mul(b.mul(this.z)))?this.doubl():new sjcl.ecc.pointJac(this.curve);b=a.y.mul(b.mul(this.z)).subM(this.y);d=c.square();a=b.square();e=c.square().mul(c).addM(this.x.add(this.x).mul(d));a=a.subM(e);b=this.x.mul(d).subM(a).mul(b);
...
var a=this.z.inverse(),b=a.square();return new sjcl.ecc.point(this.curve,this.x.mul(b).fullReduce(),this.y.mul(b.mul(a)).fullReduce())},mult:function(a,b){"number"===typeof a?a=[a]:a.limbs!==u&&(a=a.normalize().limbs);var c,d,e=(new sjcl.ecc.point(this.curve)).toJac(),f=b.multiples();for(c=a.length-1;0<=c;c--)for(d=sjcl.bn.prototype.radix-4;0<=d;d-=4)e=e.doubl().doubl().doubl().doubl().add(f[a[c]>>d&15]);return e},mult2:function(a,b,c,d){"number"===typeof a?a=[a]:a.limbs!==u&&(a=a.normalize().limbs);
"number"===typeof c?c=[c]:c.limbs!==u&&(c=c.normalize().limbs);var e,f=(new sjcl.ecc.point(this.curve)).toJac();b=b.multiples();var g=d.multiples(),h,l;for(d=Math.max(a.length,c.length)-1;0<=d;d--){h=a[d]|0;l=c[d]|0;for(e=sjcl.bn.prototype.radix-4;0<=e;e-=4)f=f.doubl().doubl().doubl().doubl().add(b[h>>e&15]).add(g[l>>e&15])}return f},isValid:function(){var a=this.z.square(),b=a.square(),a=b.mul(a);return this.y.square().equals(this.curve.b.mul(a).add(this.x.mul(this.curve.a.mul(b).add(this.x.square()))))}};
sjcl.ecc.curve=function(a,b,c,d,e,f){this.field=a;this.r=a.prototype.modulus.sub(b);this.a=new a(c);this.b=new a(d);this.G=new sjcl.ecc.point(this,new a(e),new a(f))};sjcl.ecc.curve.prototype.fromBits=function(a){var b=sjcl.bitArray,c=this.field.prototype.exponent+7&-8;a=new sjcl.ecc.point(this,this.field.fromBits(b.bitSlice(a,0,c)),this.field.fromBits(b.bitSlice(a,c,2*c)));a.isValid()||t(new sjcl.exception.corrupt("not on the curve!"));return a};
...
sjcl.ecc.U=function(a){sjcl.ecc[a]={publicKey:function(a,c){this.i=a;this.l=a.r.bitLength();this.F=c instanceof Array?a.fromBits(c):c;this.get=function(){var a=this.F.toBits(),b=sjcl.bitArray.bitLength(a),c=sjcl.bitArray.bitSlice(a,0,b/2),a=sjcl.bitArray.bitSlice(a,b/2);return{x:c,y:a}}},secretKey:function(a,c){this.i=a;this.l=a.r.bitLength();this.B=c;this.get=function(){return this.B.toBits()}},generateKeys:function(b,c,d){b===u&&(b=0x100);"number"===typeof b&&(b=sjcl.ecc.curves["c"+b],b===u&&t(new sjcl.exception.invalid("no such curve")));
d===u&&(d=sjcl.bn.random(b.r,c));c=b.G.mult(d);return{pub:new sjcl.ecc[a].publicKey(b,c),sec:new sjcl.ecc[a].secretKey(b,d)}}}};sjcl.ecc.U("elGamal");sjcl.ecc.elGamal.publicKey.prototype={kem:function(a){a=sjcl.bn.random(this.i.r,a);var b=this.i.G.mult(a).toBits();return{key:sjcl.hash.sha256.hash(this.F.mult(a).toBits()),tag:b}}};sjcl.ecc.elGamal.secretKey.prototype={unkem:function(a){return sjcl.hash.sha256.hash(this.i.fromBits(a).mult(this.B).toBits())},dh:function(a){return sjcl.hash.sha256.hash(a.F.mult(this.B).toBits())}};
sjcl.ecc.U("ecdsa");sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.l&&(a=sjcl.bitArray.clamp(a,this.l));var e=this.i.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.i.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.B));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))}};
sjcl.ecc.ecdsa.publicKey.prototype={verify:function(a,b,c){sjcl.bitArray.bitLength(a)>this.l&&(a=sjcl.bitArray.clamp(a,this.l));var d=sjcl.bitArray,e=this.i.r,f=this.l,g=sjcl.bn.fromBits(d.bitSlice(b,0,f)),d=sjcl.bn.fromBits(d.bitSlice(b,f,2*f)),h=c?d:d.inverseMod(e),f=sjcl.bn.fromBits(a).mul(h).mod(e),h=g.mul(h).mod(e),f=this.i.G.mult2(f,h,this.F).x;if(g.equals(0)||d.equals(0)||g.greaterEquals(e)||d.greaterEquals(e)||!f.equals(g)){if(c===u)return this.verify(a,b,A);t(new sjcl.exception.corrupt("signature didn't check out"))}return A}};
}, "lib/user": function(exports, require, module) {(function() {
  var User, server, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
}, "lib/view": function(exports, require, module) {(function() {
  ...
  */
  ...
  User = (function(_super) {
    ...
    User.configure('User', 'pseudo', 'email', 'pubkey', 'seckey', 'token', 'data', 'datakey');

    User.extend(Spine.Model.Ajax);

    User.exist = function(pseudo, callback) {
      var url,
        _this = this;
      url = [this.url(), pseudo].join('/');
    ...
    User.prototype.birth = function() {
      var ec, keys;
      keys = S.login(this.pseudo, this.password);
      ec = S.ec_create();
      this.datakey = keys.datakey;
      this.token = keys.token;
      this.pubkey = ec.pubkey;
      this.seckey = ec.seckey;
      return this.data = S.armor(S.hide_seckey(this.datakey, this.seckey));
    };

    User.prototype.toJSON = function() {
      var fields, key, result;
      result = {};
...
}, "views/index": function(exports, require, module) {module.exports = "<header>\n  <div id=\"center\">\n    <img src=\"logo.png\" alt=\"Safebook logo\" class=\"logo-safebook\"/>\n  </div>\n</header>\n\n<div class=\"strut\"></div><!--\n--><div class=\"body\">\n    <div id=\"content\">\n      <h2 class=\"titre\">Ouverture</h2>\n\n      <span class=\"thisis\">Pseudo</span>\n      <input type=\"text\" name=\"pseudo\" />\n      <span class=\"description\">\n        Jusqu'a 10 caractères.\n      </span>\n\n      <span class=\"thisis\">E-mail</span>\n      <input type=\"text\" name=\"email\" />\n      <span class=\"description\">\n        La validation finale du compte se déroulera dans votre boîte aux lettres !\n      </span>\n\n      <span class=\"thisis\">Mot de Passe</span>\n      <input type=\"password\" name=\"password\" />\n      <span class=\"description\">\n        Vous êtes le seul à le connaître (même pas nous). Il est le garant de votre sécurité. Il faut qu'il soit <b>long</b> (entre 8 et 12 caractère), <b>rare</b> (pas de mot du dico), <b>fort</b> (majuscules, minuscules, chiffres, ?!$% et Cie) et <b>unique</b> (ne le rentrez jamais sur un autre site). \n      </span>\n\n      <span class=\"thisis\">Confirmation</span>\n      <input type=\"password\" name=\"confirm\" />\n      <span class=\"description\">\n        Pas de fautes de frappes ? Pour des raison de sécurité nous ne pouvons ni vous le renvoyer, ni le réinitialer donc <b>ne l'oubliez surtout pas</b>. Notez le quelque part. On ne sait jamais...\n      </span>\n\n      <span class=\"thisis\"><b>Entropie</b></span>\n      <span id=\"entropy\">0</span>\n      <span class=\"description\">\n        Vous êtes encouragé à augmenter votre entropie pour un maximum de sécurité. <a href=\"#\" id=\"eat\">Eat a file</a> pour récuperer 64 octet (voir <a href=\"#\">sha512</a>)\n      </span>\n      <input type=\"file\" id=\"input_file\" style=\"display:none\" />\n\n      <a id=\"to_2\" href=\"#\" class=\"next\">S'inscrire</a>\n    </div>\n  </div>\n</div>\n";
}, "views/index": function(exports, require, module) {module.exports = function anonymous(locals) {
var buf = [];
buf.push("<header><img id=\"logo\" src=\"logo.png\" alt=\"Safebook logo\"/></header><form><h1>Bienvenue !</h1><div class=\"line\"><label for=\"pseudo\">Pseudo :</label><input id=\"pseudo\" type=\"text\" name=\"pseudo\" maxlength=\"32\"/><span class=\"description\">Votre pseudo. Composé de 2 jusqu'à 32 caractères alphanumérique, ., - et _.</span></div><div class=\"line\"><label for=\"email\">E-mail :</label><input id=\"email\" type=\"text\" name=\"email\" maxlength=\"255\"/><span class=\"description\">La validation finale du compte se déroulera dans votre boîte aux lettres !</span></div><div class=\"line\"><label for=\"email\">Mot de Passe :</label><input type=\"password\" name=\"password\"/><span class=\"description\">Votre mot de passe. Le garant de votre sécurité. Minimum 8 caractères dont une minuscule, une majuscule et un chiffre. <a href=\"/passwords\">Qu'est-ce qu'un bon mot de passe ?</a></span></div><div class=\"line\"><label for=\"confirm\">Confirmation :</label><input type=\"password\" name=\"confirm\"/><span class=\"description\"><b>Nous ne pouvons pas le renvoyer ! </b>Pas de fautes de frappes ? \nNotez le quelque part, on ne sait jamais...</span></div><div class=\"line\"><div class=\"desc\">Entropie : <span id=\"entropy\">0</span></div><span class=\"description entropy_description\">Sans <a href=\"#\">entropie</a>, pas de sécurité ! Essayez d'atteindre au moins 2500.  <a href=\"#\">Augmenter mon entropie</a></span></div><div class=\"line submit_line\"><input type=\"submit\" value=\"S'inscrire\"/></div></form>");;return buf.join("");
};}
});
